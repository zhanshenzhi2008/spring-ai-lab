CREATE database if NOT EXISTS `ai_lib` default character set utf8mb4 collate utf8mb4_0900_ai_ci;
use ai_lib;

--  alter table cd_plugin.sms_template add column `status` varchar(32) DEFAULT NULL comment '状态(draf-草稿;applying-审核中;rejected-审核失败;approved-审核通过;deleted-删除;disabled-失效)' after signature;
