...
import com.orjrs.spring.ai.lab.domain.agent.service.Agent;
...
import com.orjrs.spring.ai.lab.domain.message.service.AiMessageChatMemoryService;
import com.orjrs.spring.ai.lab.domain.message.vo.AiMessageWrapper;
...
public class AiMessageController {
    private final AiMessageChatMemoryService chatMemoryService;
    ...
    public void toPrompt(ChatClient.PromptUserSpec promptUserSpec, AiMessageInput input) {
        ...
        Message message = AiMessageChatMemoryService.toSpringAiMessage(input.toEntity());
    ...
    public void useChatHistory(ChatClient.AdvisorSpec advisorSpec, String sessionId) {
        ...
        advisorSpec.advisors(new MessageChatMemoryAdvisor(chatMemoryService, sessionId, 10));
    }
